...
GM.Strings = {
	en = {
		...
		tonight = "To Night",
		night = "Night",
		freddys_start = "Turn off the main power to start the game",
		freddys_start_2 = "Turn off the main power to start a new night",
		freddys_startanimatronics = "The main power is on",
		fnaf2_start = "Turn on the %s to start",
		fnaf2_start_2 = "Turn on the %s to start a new night",
	...
	fr = {
		freddys_start = "Coupez le courent pour démarrer",
		freddys_start_2 = "Coupez le courent pour démarrer une nouvelle nuit",
		freddys_startanimatronics = "Le courant est allumé",
		fnaf2_start = "Activez les %s pour démarrer le jeu",
		fnaf2_start_2 = "Activez les %s pour démarrer une nouvelle nuit",
	...
	tr = { --Translation by http://steamcommunity.com/profiles/76561198118981905/
		...
		fnaf2_start = "%s açarak başlayın",
		fnaf2_start_2 = "%s açarak yeni geceye başlayın",
