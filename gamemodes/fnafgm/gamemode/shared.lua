...
GM.Strings = {
	...
	tr = { --Translation by http://steamcommunity.com/profiles/76561198118981905/
		...
		spectator = "Ýzleyici",
		warn_font = "Yazý türünü yüklemediniz ya da güncellemediniz!Atölyedeki kurulum talimatlarý için F1'e basýn.",
		warn_css = "Counter Strike: Source yüklenmedi ya da seçilmedi.Haritada HATA ve Bulunamayan Texturelar var.",
		links = "Link(ler)",
		fonthint = "Yazý tipini yüklemek için atölyedeki kuruluma bakýn.",
		faqbtn = "Yardým",
		config = "Yapýlandýrma",
		hidever = "Versiyonu gizle",
		dhud = "HUD'ý göster",
		infoat = "Bilgiler/Çeþitli",
		fontloaded = "Yazý tipi yüklendi",
		lang = "Dil",
